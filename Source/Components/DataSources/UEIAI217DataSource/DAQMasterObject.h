/**
 * @file DAQMasterObject.h
 * @brief Header file for class DAQMasterObject
 * @date 08/02/2023
 * @author Xavier Ruche
 *
 ...
 * @details This header file contains the declaration of the class DAQMasterObject
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef DAQMasterObject_H_
#define DAQMasterObject_H_
...
class DAQMasterObject : public ReferenceContainer {
    public:
