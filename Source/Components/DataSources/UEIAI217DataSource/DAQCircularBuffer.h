/**
 * @file DAQCircularBuffer.h
 * @brief Header file for class DAQCircularBuffer
 * @date 08/02/2023
 * @author Xavier Ruche
 *
 ...
 * @details This header file contains the declaration of the class DAQCircularBuffer
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef DAQCircularBuffer_H_
#define DAQCircularBuffer_H_
...
class DAQCircularBuffer : public Object {
    public:
...
private:
    ...
    /*
    *   Variable depicting if this DAQCircularBuffer is provided with a timestamp channel to perform data synchronisation
    *   among DAQCircularBuffers
    */
