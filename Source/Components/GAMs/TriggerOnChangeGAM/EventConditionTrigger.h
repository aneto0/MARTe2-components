...
/**
 * @brief A structure used to hold the
 * features of each packet field
 */
struct PacketField {
    ...
    /**
     * The field offset
     * within the TriggerOnGAM memory
     */
    uint32 offset;
...
public:
    ...
    /**
     * @brief Stores a pointer to the list of PacketField elements.
     ...
     */
    bool Check(const uint8 * const packetMem,
               const PacketField * const packetFieldIn);
    ...
    public:
        ...
        /**
         * The packetField associated to this variable.
         */
        const PacketField *packetField;
