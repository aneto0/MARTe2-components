/**
 * @file BaseLib2WrapperMessageFilterTest.cpp
 * @brief Source file for class BaseLib2WrapperMessageFilterTest
 * @date 05/12/2016
 * @author Andre Neto
 *
 ...
 * the class BaseLib2WrapperMessageFilterTest (public, protected, and private). Be aware that some 
...
/*                           Method definitions                              */
/*---------------------------------------------------------------------------*/
bool BaseLib2WrapperMessageFilterTest::TestConstructor() {
    MARTe::BaseLib2WrapperMessageFilter test;
    return true;
}

bool BaseLib2WrapperMessageFilterTest::TestConsumeMessage() {
