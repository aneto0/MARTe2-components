...
bool EPICSPVA2V3ServiceTest::Testrequest_False_invalid_dimensions() {
    using namespace MARTe;
    StreamString config = ""
            "+EPICSRPCServer = {\n"
            "    Class = EPICSPVA::EPICSRPCServer\n"
...
bool EPICSPVA2V3ServiceTest::Testrequest_False_invalid_elements() {
    using namespace MARTe;
    StreamString config = ""
            "+EPICSRPCServer = {\n"
            "    Class = EPICSPVA::EPICSRPCServer\n"
    ...
    if (ok) {
        ...
        uint32 valuesArr[] = { 4, 5, 6, 7, 3 };
        Vector<uint32> valuesVec(valuesArr);
        uint32 valuesArrWrong[] = { 4, 5, 6 };
        Vector<uint32> valuesVecWrong(valuesArrWrong);
        cdb->Write("value4", valuesVecWrong);
        cdb->MoveToRoot();
        CRC<uint32> crc;
        uint32 pol = 0x12345678;
        crc.ComputeTable(pol);
...
bool EPICSPVA2V3ServiceTest::Testrequest_False_invalid_type() {
    using namespace MARTe;
    StreamString config = ""
            "+EPICSRPCServer = {\n"
            "    Class = EPICSPVA::EPICSRPCServer\n"
    ...
    if (ok) {
        ...
        uint32 valuesArr[] = { 4, 5, 6, 7, 3 };
        Vector<uint32> valuesVec(valuesArr);
        uint16 valuesArrWrong[] = { 4, 5, 6, 7, 3 };
        Vector<uint16> valuesVecWrong(valuesArrWrong);
        cdb->Write("value4", valuesVecWrong);
        cdb->MoveToRoot();
        CRC<uint32> crc;
        uint32 pol = 0x12345678;
...
bool EPICSPVA2V3ServiceTest::Testrequest_False_invalid_node() {
    using namespace MARTe;
    StreamString config = ""
            "+EPICSRPCServer = {\n"
            "    Class = EPICSPVA::EPICSRPCServer\n"
    ...
    if (ok) {
        ...
        uint16 valuesArrWrong[] = { 4, 5, 6, 7, 3 };
        Vector<uint16> valuesVecWrong(valuesArrWrong);
        cdb->MoveAbsolute("value");
        cdb->Write("value5", valuesVecWrong);
        cdb->MoveToRoot();
