/**
 * @file EPICSRPCClientMessageFilterTest.cpp
 * @brief Source file for class EPICSRPCClientMessageFilterTest
 * @date 07/09/2018
 * @author Andre Neto
 *
 ...
 * the class EPICSRPCClientMessageFilterTest (public, protected, and private). Be aware that some 
...
#include "EPICSRPCClientMessageFilterTest.h"
...
bool EPICSRPCClientMessageFilterTest::TestConstructor() {
    using namespace MARTe;
    EPICSRPCClientMessageFilter test;
    return test.IsPermanentFilter();
}

bool EPICSRPCClientMessageFilterTest::TestConsumeMessage() {
    using namespace MARTe;
    StreamString config = ""
            "+EPICSRPCServer = {"
