/**
 * @file OPCUAMessageClientTest.h
 * @brief Header file for class OPCUAMessageClientTest
 * @date Oct 21, 2019 TODO Verify the value and format of the date
 ...
 * @details This header file contains the declaration of the class OPCUAMessageClientTest
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef TEST_COMPONENTS_INTERFACES_OPCUA_OPCUAMESSAGECLIENTTEST_H_
#define TEST_COMPONENTS_INTERFACES_OPCUA_OPCUAMESSAGECLIENTTEST_H_
...
/**
 * @brief Tests the OPCUAMessageClient public methods.
 */
class OPCUAMessageClientTest {
public:
    ...
    /**
     * @brief Tests the Initialise method with no Server Address specified.
     */
    bool TestInitialise_NoServerAddress();

    /**
     * @brief Tests the Initialise method with no Method Node specified in the cdb.
     */
    bool TestInitialise_NoMethodSection();

    /**
     * @brief Tests the Initialise method with no NamespaceIndex specified for the Method.
     */
    bool TestInitialise_NoNamespaceIndex_Method();

    /**
     * @brief Tests the Initialise method with no Path specified for the Method.
     */
    bool TestInitialise_NoPath_Method();

    /**
     * @brief Tests the Initialise method with no Structure Node specified in the cdb.
     */
    bool TestInitialise_NoStructureSection();

    /**
     * @brief Tests the Initialise method with no Path specified for the Structure.
     */
    bool TestInitialise_NoPath_Structure();

    /**
     * @brief Tests the Initialise method with no NamespaceIndex specified for the Structure.
     */
    bool TestInitialise_NoNamespaceIndex_Structure();

    /**
     * @brief Tests the Initialise method with no NumberOfElements specified for the Structure.
     */
    bool TestInitialise_NoNumberOfElements_Structure();

    /**
     * @brief Tests the Initialise method with no Type specified for the Structure.
     */
    bool TestInitialise_NoType_Structure();

    /**
     * @brief Tests the OPCUAMethodCall method with a wrong received structure.
     */
    bool TestOPCUAMethodCall_WrongMessage();
...
class OPCUATestCall: public MARTe::Object, public MARTe::MessageI {
public:CLASS_REGISTER_DECLARATION()
    ...
    MARTe::ErrorManagement::ErrorType TestMethodCall_Single() {
        using namespace MARTe;
        ReferenceT<Message> msg(GlobalObjectsDatabase::Instance()->GetStandardHeap());
        ConfigurationDatabase cdbMsg;
        cdbMsg.Write("Destination", "MessageClient");
        cdbMsg.Write("Function", "OPCUAMethodCall");
        cdbMsg.CreateRelative("+Parameters");
    ...
    MARTe::ErrorManagement::ErrorType TestMethodCall_Wrong() {
        using namespace MARTe;
        ReferenceT<Message> msg(GlobalObjectsDatabase::Instance()->GetStandardHeap());
        ConfigurationDatabase cdbMsg;
        cdbMsg.Write("Destination", "MessageClient");
    ...
    MARTe::ErrorManagement::ErrorType TestMethodCall_Array() {
        using namespace MARTe;
        ReferenceT<Message> msg(GlobalObjectsDatabase::Instance()->GetStandardHeap());
        ConfigurationDatabase cdbMsg;
        cdbMsg.Write("Destination", "MessageClient");
        ...
        cdbMsg.Write("x", 1.0);
        cdbMsg.Write("y", 1.0);
        float64 zValues[2] = {1.0, 1.0};
        cdbMsg.Write("z", zValues);
        cdbMsg.MoveToAncestor(1u);
        bool ok = msg->Initialise(cdbMsg);
        if (ok) {
            ok = (MessageI::SendMessage(msg, this) == ErrorManagement::NoError);
...
#endif /* TEST_COMPONENTS_INTERFACES_OPCUA_OPCUAMESSAGECLIENTTEST_H_ */
