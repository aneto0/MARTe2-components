...
//bool MathExpressionGAMTest::TestSetup_LessInputs() {
    //using namespace MARTe;
    //const MARTe::char8 * const config1 = ""
            //"$Test = {"
            //"    Class = RealTimeApplication"
...
//bool MathExpressionGAMTest::TestSetup_DifferentType() {
    //using namespace MARTe;
    //const MARTe::char8 * const config1 = ""
            //"$Test = {"
            //"    Class = RealTimeApplication"
...
//bool MathExpressionGAMTest::TestSetup_False_DifferentSize() {
    //using namespace MARTe;
    //const MARTe::char8 * const config1 = ""
            //"$Test = {"
            //"    Class = RealTimeApplication"
