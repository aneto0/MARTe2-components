...
if hasGetmmiFcn == true
    set_param(model_name, 'CustomSourceCode', ...
        [ ...
        '#define CONCAT(str1, str2) CONCAT_(str1, str2)' newline, ...
        '#define CONCAT_(str1, str2) str1 ## str2' newline, ...
        '#define CONCAT3(str1, str2, str3) CONCAT3_(str1, str2, str3)' newline, ...
        '#define CONCAT3_(str1, str2, str3) str1 ## str2 ## str3' newline, ...
        'void* CONCAT(THISMODELNAME, _GetCAPImmi) (void* voidPtrToRealTimeStructure)' newline, ...
        '{' newline, ...
        '   rtwCAPI_ModelMappingInfo* mmiPtr = &(rtmGetDataMapInfo(( CONCAT3(RT_MODEL_, THISMODELNAME, _T*) )(voidPtrToRealTimeStructure)).mmi);' newline, ...
        '   return (void*) mmiPtr;' newline, ...
        '}' ...
        ] ...
    );

    set_param(model_name, 'CustomDefine', '-DTHISMODELNAME=$(PRODUCT_NAME)');
end
