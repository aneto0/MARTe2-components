...
for c = 1:modelComplexity
    ...
    if hasStructSignals || hasStructArraySignals
        ...
        if c == 3
            if hasStructArraySignals
                bus_elem_dims = [structarray_shapes(1), structarray_shapes(2), structarray_shapes(3)];
            else
                bus_elem_dims = ["1", "1", "1"];
            end
            ...
            evalin('base', strcat( ...
                ...
                'busElems(1).Dimensions = ', bus_elem_dims(2), ';', ...
                'busElems(1).DimensionsMode = "Fixed";', ...
            ...
            evalin('base', strcat( ...
                ...
                'busElems(2).Dimensions = ', bus_elem_dims(3), ';', ...
                'busElems(2).DimensionsMode = "Fixed";', ...
        ...
        if c == 4
            ...
            evalin('base', strcat( ...
                'busElems(1) = Simulink.BusElement;', ...
                'busElems(1).Name = "Scalar_Structured";', ...
                'busElems(1).Dimensions = ', bus_elem_dims(1), ';', ...
                'busElems(1).DimensionsMode = "Fixed";', ...
                'busElems(1).DataType = "Bus: STRUCTSIGNAL_T_12";', ...
                'busElems(1).SampleTime = -1;', ...
                'busElems(1).Complexity = "real";' ...
                ));
            ...
            evalin('base', strcat( ...
                'busElems(2) = Simulink.BusElement;', ...
                'busElems(2).Name = "Vector_Structured";', ...
                'busElems(2).Dimensions = ', bus_elem_dims(2), ';', ...
                'busElems(2).DimensionsMode = "Fixed";', ...
                'busElems(2).DataType = "Bus: STRUCTSIGNAL_T_34";', ...
                'busElems(2).SampleTime = -1;', ...
                'busElems(2).Complexity = "real";' ...
                ));
    
            evalin('base', strcat( ...
                'STRUCTSIGNAL_T_1234 = Simulink.Bus;', ...
                'STRUCTSIGNAL_T_1234.Elements = busElems;' ...
                ));
    
            add_block('simulink/Signal Routing/Bus Creator', [model_name '/Out1234_BusCreator'], ...
                'Inputs',         '2', ...
                'NonVirtualBus',  'on', ...
                'OutDataTypeStr', 'Bus: STRUCTSIGNAL_T_1234', ...
                'InheritFromInputs', 'off');
        end
    end
    ...
    if hasOutputs
        ...
        if hasStructSignals
            ...
            if c == 4
                outPorts(end + 1) = add_block('simulink/Sinks/Out1',  [model_name '/Out1234_NonVirtualBus'], ...
                    'SignalName',     'Out1234_NonVirtualBus', ...
                    'IconDisplay',    'Signal name', ...
                    'OutDataTypeStr', 'Inherit: auto');
            end
        end
        ...
        if hasStructSignals
            ...
            if c == 4
                add_block('simulink/Sinks/Terminator',  [model_name '/Out1234_NonVirtualBus']);
            end
        end
    end
    ...
    if hasLoggingSignals
        ...
        if hasStructSignals
            ...
            if c == 4
                subsystem_name = strcat("/Log1234_NonVirtualBus");
                logBlocks(end + 1) = add_block('simulink/Ports & Subsystems/Atomic Subsystem', strcat(model_name, subsystem_name));
            end
        end
    end
    ...
    if hasStructSignals
        ...
        if c == 4
            if hasStructArraySignals
                add_line(model_name, 'Assignment12_NonVirtualBus/1',   'Out1234_BusCreator/1');
                add_line(model_name, 'Assignment34_NonVirtualBus/1',   'Out1234_BusCreator/2');
            else
                add_line(model_name, 'Out12_BusCreator/1',   'Out1234_BusCreator/1');
                add_line(model_name, 'Out34_BusCreator/1',   'Out1234_BusCreator/2');
            end
        end
    end
    ...
    if ~hasLoggingSignals
        ...
        if hasStructSignals
            ...
            if c == 4
                add_line(model_name, 'Out1234_BusCreator/1', 'Out1234_NonVirtualBus/1');
            end
        end
        ...
        if hasStructSignals
            ...
            if c == 4
                add_line(model_name, 'Out1234_BusCreator/1', 'Log1234_NonVirtualBus/1');
                add_line(model_name, 'Log1234_NonVirtualBus/1', 'Out1234_NonVirtualBus/1');
            end
        end
    end
