...
TEST(PIDGAMGTest,TestInitialiseWrongNumberOfInputs) {
    PIDGAMTest test;
    ASSERT_TRUE(test.TestInitialiseWrongNumberOfInputs());
}

TEST(PIDGAMGTest,TestInitialiseWrongNumberOfInputs2) {
    PIDGAMTest test;
    ASSERT_TRUE(test.TestInitialiseWrongNumberOfInputs2());
}
