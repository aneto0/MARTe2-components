...
bool EPICSPVAOutputTest::TestSynchronise() {
    ...
    StreamString config = ""
            ...
            "                    Alias = Record1.UnsignedIntegers.UInt8\n"
            "                }\n"
            "                SignalUInt16 = {\n"
            "                    Type = uint16\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record1.UnsignedIntegers.UInt16\n"
            "                }\n"
            "                SignalUInt32 = {\n"
            "                    Type = uint32\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record1.UnsignedIntegers.UInt32\n"
            "                }\n"
            "                SignalUInt64 = {\n"
            "                    Type = uint64\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record1.UnsignedIntegers.UInt64\n"
            "                }\n"
            "                SignalFloat64 = {\n"
            "                    Type = float64\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record4.Element1\n"
            "                }\n"
            "                SignalInt8 = {\n"
            "                    Type = int8\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record2.SignedIntegers.Int8\n"
            "                }\n"
            "                SignalInt16 = {\n"
            "                    Type = int16\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record2.SignedIntegers.Int16\n"
            "                }\n"
            "                SignalInt32 = {\n"
            "                    Type = int32\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record2.SignedIntegers.Int32\n"
            "                }\n"
            "                SignalIn64 = {\n"
            "                    Type = int64\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record2.SignedIntegers.Int64\n"
            "                }\n"
            "                SignalFloat32 = {\n"
            "                    Type = float32\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record3.Element1\n"
            "                }\n"
            "            }\n"
            "        }\n"
            "    }\n"
    ...
    if (ok) {
        ...
        *gam1->float64Signal = 64;
        ...
        while ((!ok) && (timeOutCounts != 0u)) {
            {
                pvac::ClientChannel record1(provider.connect("Record1"));
            ...
            {
                pvac::ClientChannel record2(provider.connect("Record2"));
            ...
            {
                pvac::ClientChannel record3(provider.connect("Record3"));
            ...
            {
                pvac::ClientChannel record4(provider.connect("Record4"));
...
bool EPICSPVAOutputTest::TestSynchronise_Arrays() {
    ...
    StreamString config = ""
            ...
            "                    Type = uint8\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record1Arr.UnsignedIntegers.UInt8\n"
            "                    NumberOfElements = 4\n"
            "                }\n"
            "                SignalUInt16 = {\n"
            "                    Type = uint16\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record1Arr.UnsignedIntegers.UInt16\n"
            "                    NumberOfElements = 4\n"
            "                }\n"
            "                SignalUInt32 = {\n"
            "                    Type = uint32\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record1Arr.UnsignedIntegers.UInt32\n"
            "                    NumberOfElements = 4\n"
            "                }\n"
            "                SignalUInt64 = {\n"
            "                    Type = uint64\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record1Arr.UnsignedIntegers.UInt64\n"
            "                    NumberOfElements = 4\n"
            "                }\n"
            "                SignalFloat64 = {\n"
            "                    Type = float64\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record4Arr.Element1\n"
            "                    NumberOfElements = 4\n"
            "                }\n"
            "                SignalInt8 = {\n"
            "                    Type = int8\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record2Arr.SignedIntegers.Int8\n"
            "                    NumberOfElements = 4\n"
            "                }\n"
            "                SignalInt16 = {\n"
            "                    Type = int16\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record2Arr.SignedIntegers.Int16\n"
            "                    NumberOfElements = 4\n"
            "                }\n"
            "                SignalInt32 = {\n"
            "                    Type = int32\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record2Arr.SignedIntegers.Int32\n"
            "                    NumberOfElements = 4\n"
            "                }\n"
            "                SignalIn64 = {\n"
            "                    Type = int64\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record2Arr.SignedIntegers.Int64\n"
            "                    NumberOfElements = 4\n"
            "                }\n"
            "                SignalFloat32 = {\n"
            "                    Type = float32\n"
            "                    DataSource = EPICSPVAOutputTest\n"
            "                    Alias = Record3Arr.Element1\n"
            "                    NumberOfElements = 4\n"
            "                }\n"
            "            }\n"
            "        }\n"
    ...
    if (ok) {
        ...
        while ((!ok) && (timeOutCounts != 0u)) {
            {
                pvac::ClientChannel record1(provider.connect("Record1Arr"));
                epics::pvData::PVStructure::const_shared_pointer getStruct = record1.get();
