...
bool OPCUADSOutputTest::TestInitialise_ExtensionObject() {
    ...
    StreamString config = ""
            ...
            "                    DataSource = OPCUAOut\n"
            "                    Trigger = 1\n"
            "                    TriggerSignal = \"MasterSet.SensorPackage.Sensor1\"\n"
            "                }\n"
            "            }\n"
            "        }\n"
            "    }\n"
...
bool OPCUADSOutputTest::TestInitialise_MoreThanOneExtensionObject() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::TestInitialise_MoreThanOneStruct() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::TestInitialise_ExtensionObject_NoPath() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::TestInitialise_ExtensionObject_NoNamespaceIndex() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::TestInitialise_Struct_NoPath () {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::TestInitialise_Struct_NoNamespaceIndex () {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::TestInitialise_Authentication_InvalidParameter() {
    using namespace MARTe;
    StreamString config = ""
            "$Test = {\n"
            "    Class = RealTimeApplication\n"
...
bool OPCUADSOutputTest::TestInitialise_Authentication_InvalidFile() {
    using namespace MARTe;
    StreamString config = ""
            "+ServerTest = {\n"
            ...
            "            Address = \"opc.tcp://localhost.localdomain:4840\"\n"
            "            Authentication = UserPassword\n"
            "            UserPasswordFile = /tmp/doesnotexist.cfg\n"
            "            Signals = {\n"
            "                Counter = {\n"
            "                    NamespaceIndex = 1\n"
            "                    Path = Counter\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_ExtensionObject_MixedSignal() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_ExtensionObject_MixedSignals() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_Struct_MixedSignal() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_Struct_MixedSignals() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_MoreThanOneDefaultTimestamp() {
    using namespace MARTe;
    StreamString config = ""
            "+ServerTest = {\n"
            "  Class = OPCUA::OPCUAServer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_TimestampNotUint64() {
    using namespace MARTe;
    StreamString config = ""
            "+ServerTest = {\n"
            "  Class = OPCUA::OPCUAServer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_TimestampNotScalar() {
    using namespace MARTe;
    StreamString config = ""
            "+ServerTest = {\n"
            "  Class = OPCUA::OPCUAServer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_TimestampNonExisting() {
    using namespace MARTe;
    StreamString config = ""
            "+ServerTest = {\n"
            "  Class = OPCUA::OPCUAServer\n"
            ...
            "        }\n"
            "        Timestamp2 = {\n"
            "          Timestamp = {\"DoesNotExist\" \"SignalFloat64A\"}\n"
            "          Type = uint64\n"
            "        }\n"
            "        SignalInt8 = {\n"
            "          NamespaceIndex = 1\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_NoTrigger() {
    using namespace MARTe;
    StreamString config = ""
            "+ServerTest = {\n"
            "  Class = OPCUA::OPCUAServer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_ExtensionObject_Timestamp_NotDefault() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_ExtensionObject_MoreThanOneTimestamp() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_Struct_Timestamp_NotDefault() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_Struct_MoreThanOneTimestamp() {
    using namespace MARTe;
    StreamString config = ""
            "+OPCUATypes = {\n"
            "  Class = ReferenceContainer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_MoreThanOneTrigger() {
    using namespace MARTe;
    StreamString config = ""
            "+ServerTest = {\n"
            "  Class = OPCUA::OPCUAServer\n"
...
bool OPCUADSOutputTest::Test_SetConfiguredDatabase_InputSignals() {
    using namespace MARTe;
    StreamString config = ""
            "+ServerTest = {\n"
            "  Class = OPCUA::OPCUAServer\n"
            ...
            "          Class = RealTimeThread\n"
            "          CPUs = 0x2\n"
            "          Functions = {GAMWriterTimestamp1 GAMInput GAMWriterScalar GAMWriterArray}\n"
            "        }\n"
            "      }\n"
            "    }\n"
            "  }\n"
...
bool OPCUADSOutputTest::Test_Synchronise_Struct() {
    using namespace MARTe;
    StreamString config = ""
            "+Types = {\n"
            "  Class = ReferenceContainer"
            ...
            "          Type = uint8\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          Alias = Composed.Scalar.NodeU8\n"
            "        }\n"
            "        SignalUInt16 = {\n"
            "          Type = uint16\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          Alias = Composed.Scalar.NodeU16\n"
            "        }\n"
            "        SignalUInt32 = {\n"
            "          Type = uint32\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          Alias = Composed.Scalar.NodeU32\n"
            "        }\n"
            "        SignalUInt64 = {\n"
            "          Type = uint64\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          Alias = Composed.Scalar.NodeU64\n"
            "        }\n"
            "        SignalInt8 = {\n"
            "          Type = int8\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          Alias = Composed.Scalar.NodeI8\n"
            "        }\n"
            "        SignalInt16 = {\n"
            "          Type = int16\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          Alias = Composed.Scalar.NodeI16\n"
            "        }\n"
            "        SignalInt32 = {\n"
            "          Type = int32\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          Alias = Composed.Scalar.NodeI32\n"
            "        }\n"
            "        SignalInt64 = {\n"
            "          Type = int64\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          Alias = Composed.Scalar.NodeI64\n"
            "        }\n"
            "        SignalFloat32 = {\n"
            "          Type = float32\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          Alias = Composed.Scalar.NodeF32\n"
            "        }\n"
            "        SignalFloat64 = {\n"
            "          Type = float64\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          Alias = Composed.Scalar.NodeF64\n"
            "        }\n"
            "      }\n"
            "    }\n"
            "    +GAMWriterArray = {\n"
            ...
            "          DataSource = OPCUADSOutputTest\n"
            "          NumberOfElements = 3\n"
            "          Alias = Composed.Array.NodeU8A\n"
            "          TriggerSignal = Composed.Array.NodeU8A\n"
            "        }\n"
            "        SignalUInt16A = {\n"
            "          Type = uint16\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          NumberOfElements = 3\n"
            "          Alias = Composed.Array.NodeU16A\n"
            "        }\n"
            "        SignalUInt32A = {\n"
            "          Type = uint32\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          NumberOfElements = 3\n"
            "          Alias = Composed.Array.NodeU32A\n"
            "        }\n"
            "        SignalUInt64A = {\n"
            "          Type = uint64\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          NumberOfElements = 3\n"
            "          Alias = Composed.Array.NodeU64A\n"
            "        }\n"
            "        SignalInt8A = {\n"
            "          Type = int8\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          NumberOfElements = 3\n"
            "          Alias = Composed.Array.NodeI8A\n"
            "        }\n"
            "        SignalInt16A = {\n"
            "          Type = int16\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          NumberOfElements = 3\n"
            "          Alias = Composed.Array.NodeI16A\n"
            "        }\n"
            "        SignalInt32A = {\n"
            "          Type = int32\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          NumberOfElements = 3\n"
            "          Alias = Composed.Array.NodeI32A\n"
            "        }\n"
            "        SignalInt64A = {\n"
            "          Type = int64\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          NumberOfElements = 3\n"
            "          Alias = Composed.Array.NodeI64A\n"
            "        }\n"
            "        SignalFloat32A = {\n"
            "          Type = float32\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          NumberOfElements = 3\n"
            "          Alias = Composed.Array.NodeF32A\n"
            "        }\n"
            "        SignalFloat64A = {\n"
            "          Type = float64\n"
            "          DataSource = OPCUADSOutputTest\n"
            "          NumberOfElements = 3\n"
            "          Alias = Composed.Array.NodeF64A\n"
            "        }\n"
            "      }\n"
            "    }\n"
            "  }\n"
    ...
    if (ok) {
        UA_NodeId ignore;
        ok = (opcuaReader.FindChildNodeId("ComposedQ", &parentL1) == UA_STATUSCODE_GOOD);
    }
    if (ok) {
        UA_NodeId ignore;
        ok = (opcuaReader.FindChildNodeId("Scalar", &parentL2S, parentL1) == UA_STATUSCODE_GOOD);
    }
    if (ok) {
        UA_NodeId ignore;
        ok = (opcuaReader.FindChildNodeId("Array", &parentL2A, parentL1) == UA_STATUSCODE_GOOD);
    }

    if (ok) {
        for (uint32 k=0; (k<numberOfNodes / 2) && (ok); k++) {
            ok = (opcuaReader.FindChildNodeId(nodeNames[k], &nodeIds[k], parentL2S) == UA_STATUSCODE_GOOD);
        }
        for (uint32 k=(numberOfNodes / 2); (k<numberOfNodes) && (ok); k++) {
            ok = (opcuaReader.FindChildNodeId(nodeNames[k], &nodeIds[k], parentL2A) == UA_STATUSCODE_GOOD);
        }
    }
    if (ok) {
        *gamWriterScalar->uint8Signal = 1u;
...
bool OPCUADSOutputTest::Test_Synchronise_Struct_Timestamp_Idx_0() {
    using namespace MARTe;
    StreamString config = ""
            "+Types = {\n"
            "  Class = ReferenceContainer"
    ...
    if (ok) {
        ...
        *gamWriterTimestamp1->uint64Signal = 1193227200123456790;
        scheduler->ExecuteThreadCycle(0u);
        for(uint32 k=0; (k<numberOfNodes) && (ok); k++) {
            //printf("Checking %d %s %d\n", k, nodeNames[k], nodeNElements[k]);
            ok = opcuaReader.WaitForValue(nodeIds[k], reinterpret_cast<uint8 *>(expectedNodeValues[k]), nodeDataTypes[k], nodeTypeSizes[k], nodeNElements[k]);
...
bool OPCUADSOutputTest::Test_Synchronise_Struct_Timestamp_Idx_Last() {
    using namespace MARTe;
    StreamString config = ""
            "+Types = {\n"
            "  Class = ReferenceContainer"
