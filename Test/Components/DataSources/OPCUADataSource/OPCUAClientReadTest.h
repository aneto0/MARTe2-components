 ...
 * @details This header file contains the declaration of the class OPCUAClientReadTest
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef TEST_COMPONENTS_DATASOURCES_OPCUADATASOURCE_OPCUACLIENTREADTEST_H_
#define TEST_COMPONENTS_DATASOURCES_OPCUADATASOURCE_OPCUACLIENTREADTEST_H_
...
private:
    ...
    private:
        void add3PointDataType(UA_Server *server) {
            ...
            UA_Server_addVariableTypeNode(server, PointType.typeId, UA_NODEID_NUMERIC(0, UA_NS0ID_BASEDATAVARIABLETYPE), UA_NODEID_NUMERIC(0, UA_NS0ID_HASSUBTYPE),
                                          UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("Point")), UA_NODEID_NUMERIC(0, UA_NS0ID_BASEDATAVARIABLETYPE), dattr, NULL, NULL);
        ...
        void add3DPointVariable(UA_Server *server) {
            ...
            UA_Server_addVariableNode(server, UA_NODEID_STRING(1, const_cast<MARTe::char8*>("Point")), UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER), UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES),
                                      UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("Point")), PointType.typeId, vattr, NULL, NULL);
        }
        ...
        void add3DPointArraySByteVariable(UA_Server *server,
            ...
            UA_Server_addVariableNode(server, UA_NODEID_STRING(1, const_cast<MARTe::char8*>("PointArraySByte")), UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                                      UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES), UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("PointArraySByte")), PointArraySByteType.typeId, vattr, NULL,
                                      NULL);
        }
        ...
        void add3DPointArrayByteVariable(UA_Server *server,
            ...
            UA_Server_addVariableNode(server, UA_NODEID_STRING(1, const_cast<MARTe::char8*>("PointArrayByte")), UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                                      UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES), UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("PointArrayByte")), PointArrayByteType.typeId, vattr, NULL,
                                      NULL);
        }
        ...
        void add3DPointArrayInt16Variable(UA_Server *server,
            ...
            UA_Server_addVariableNode(server, UA_NODEID_STRING(1, const_cast<MARTe::char8*>("PointArrayInt16")), UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                                      UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES), UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("PointArrayInt16")), PointArrayInt16Type.typeId, vattr, NULL,
                                      NULL);
        }
        ...
        void add3DPointArrayUInt16Variable(UA_Server *server,
            ...
            UA_Server_addVariableNode(server, UA_NODEID_STRING(1, const_cast<MARTe::char8*>("PointArrayUInt16")), UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                                      UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES), UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("PointArrayUInt16")), PointArrayUInt16Type.typeId, vattr, NULL,
                                      NULL);
        }
        ...
        void add3DPointArrayInt32Variable(UA_Server *server,
            ...
            UA_Server_addVariableNode(server, UA_NODEID_STRING(1, const_cast<MARTe::char8*>("PointArrayInt32")), UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                                      UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES), UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("PointArrayInt32")), PointArrayInt32Type.typeId, vattr, NULL,
                                      NULL);
        }
        ...
        void add3DPointArrayUInt32Variable(UA_Server *server,
            ...
            UA_Server_addVariableNode(server, UA_NODEID_STRING(1, const_cast<MARTe::char8*>("PointArrayUInt32")), UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                                      UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES), UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("PointArrayUInt32")), PointArrayUInt32Type.typeId, vattr, NULL,
                                      NULL);
        }
        ...
        void add3DPointArrayInt64Variable(UA_Server *server,
            ...
            UA_Server_addVariableNode(server, UA_NODEID_STRING(1, const_cast<MARTe::char8*>("PointArrayInt64")), UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                                      UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES), UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("PointArrayInt64")), PointArrayInt64Type.typeId, vattr, NULL,
                                      NULL);
        }
        ...
        void add3DPointArrayUInt64Variable(UA_Server *server,
            ...
            UA_Server_addVariableNode(server, UA_NODEID_STRING(1, const_cast<MARTe::char8*>("PointArrayUInt64")), UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                                      UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES), UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("PointArrayUInt64")), PointArrayUInt64Type.typeId, vattr, NULL,
                                      NULL);
        }
        ...
        void add3DPointArrayFloatVariable(UA_Server *server,
            ...
            UA_Server_addVariableNode(server, UA_NODEID_STRING(1, const_cast<MARTe::char8*>("PointArrayFloat")), UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                                      UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES), UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("PointArrayFloat")), PointArrayFloatType.typeId, vattr, NULL,
                                      NULL);
        }
        ...
        void add3DPointArrayDoubleVariable(UA_Server *server,
            ...
            UA_Server_addVariableNode(server, UA_NODEID_STRING(1, const_cast<MARTe::char8*>("PointArrayDouble")), UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                                      UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES), UA_QUALIFIEDNAME(1, const_cast<MARTe::char8*>("PointArrayDouble")), PointArrayDoubleType.typeId, vattr, NULL,
                                      NULL);
        }
...
#endif /* TEST_COMPONENTS_DATASOURCES_OPCUADATASOURCE_OPCUACLIENTREADTEST_H_ */
