/**
 * @file ThreadedSDNSubscriberTest.h
 * @brief Header file for class ThreadedSDNSubscriberTest
 * @date 20/12/2016
...
#ifndef THREADEDSDNSUBSCRIBERTEST_H_
#define THREADEDSDNSUBSCRIBERTEST_H_
...
/**
 * @brief Tests the ThreadedSDNSubscriber public methods.
 */
class ThreadedSDNSubscriberTest {
...
#endif /* THREADEDSDNSUBSCRIBERTEST_H_ */
